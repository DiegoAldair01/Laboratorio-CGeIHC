...
int main()
{
	...
	Coche = Model();
	Coche.LoadModel("modelos_coche/coche.obj");

	Llanta_del_der = Model();
	Llanta_del_der.LoadModel("modelos_coche/llanta_delantera_der.obj");

	Llanta_del_izq = Model();
	Llanta_del_izq.LoadModel("modelos_coche/llanta_delantera_izq.obj");

	Llanta_trasera_der = Model();
	Llanta_trasera_der.LoadModel("modelos_coche/llanta_trasera_der.obj");

	Llanta_trasera_izq = Model();
	Llanta_trasera_izq.LoadModel("modelos_coche/llanta_trasera_izq.obj");

	Cofre = Model();
	Cofre.LoadModel("modelos_coche/cofre.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getmoverse()));
		modelaux = model; // Punto de partdida de los demas objetos
		color = glm::vec3(0.537f, 0.016f, 0.016f); //coche de color
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); 
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//llanta delantera derecha
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f); //llantas negras
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//cofre
		color = glm::vec3(0.957f, 0.247f, 0.094f); //cofre de color
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
